...
const unsigned SIZE_FIELD_LENGTH = sizeof(unsigned);

const unsigned SIZE_RECORD_LENGTH = sizeof(unsigned);
const unsigned SIZE_RECORD_OFFSET = sizeof(unsigned);
const unsigned SIZE_RECORD_POS = SIZE_RECORD_LENGTH + SIZE_RECORD_OFFSET;

const unsigned SIZE_NUM_RECORD = sizeof(unsigned);
const unsigned MAX_FREESPACE = PAGE_SIZE - SIZE_NUM_RECORD;
